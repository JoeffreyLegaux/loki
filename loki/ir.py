...
class Loop(InternalNode):
    ...
    **kwargs : optional
    ...
    bounds: Tuple[Expression] = None
    body: Tuple[Node] = None
    pragma: Node = None
    pragma_post: Node = None
    loop_label: object = None
    name: str = None
